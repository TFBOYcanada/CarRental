...
pklocation='M2N (North York, ON, CA)'
pkupdate=18
drpofdate=22


def CostcoCar(pklocation,pkupdate,drpofdate):
    ...
    begin='//*[@id="ui-datepicker-div"]/div[1]/table/tbody/tr['
    middle=']/td['
    row=str(pkupdate//7+1)
    col=str(pkupdate%7+1)
    tail=']'
    thursday=begin+row+middle+col+tail
    ...
    begin='//*[@id="ui-datepicker-div"]/div[1]/table/tbody/tr['
    middle=']/td['
    row=str(drpofdate//7+1)
    col=str(drpofdate%7+1)
    tail=']'
    monday=begin+row+middle+col+tail
    cb(monday)
...
CostcoCar(pklocation,pkupdate,drpofdate)